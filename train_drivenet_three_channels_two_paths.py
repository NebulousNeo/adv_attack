...
drive_net_dataset = 0
cwd = os.getcwd()
train_two_times = list()
print("--------INITIALIZE MODEL-------")
model = DriveNet()

# for raw_imgs_path in parameters['raw_imgs_path']:

# train_two_times.append([parameters['raw_imgs_path'][0], parameters['raw_imgs_path'][1]])
train_two_times.append([parameters['raw_imgs_path'][0], parameters['raw_imgs_path'][2]])
#train_two_times.append([parameters['raw_imgs_path'][0], parameters['raw_imgs_path'][3]])
#train_two_times.append([parameters['raw_imgs_path'][0], parameters['raw_imgs_path'][7]])
#train_two_times.append([parameters['raw_imgs_path'][1], parameters['raw_imgs_path'][2]])
#train_two_times.append([parameters['raw_imgs_path'][1], parameters['raw_imgs_path'][3]])
#train_two_times.append([parameters['raw_imgs_path'][1], parameters['raw_imgs_path'][7]])
#train_two_times.append([parameters['raw_imgs_path'][2], parameters['raw_imgs_path'][3]])
#train_two_times.append([parameters['raw_imgs_path'][2], parameters['raw_imgs_path'][7]])
#train_two_times.append([parameters['raw_imgs_path'][3], parameters['raw_imgs_path'][7]])
for first_and_second_folder in train_two_times:
    for raw_imgs_path_idx, raw_imgs_path in enumerate(first_and_second_folder):
    #for raw_imgs_path in parameters['raw_imgs_path'][21:22]:
